...
<html lang="fr">
  <head>
    ...
    <!-- Bootstrap -->
    <link href="/PHP/boutique/inc/css/bootstrap.min.css" rel="stylesheet">
    <link href="/PHP/boutique/inc/css/style.css" rel="stylesheet">
	<link rel="icon" type="image/png" href="/PHP/boutique2/inc/img/logo2.png" />
    ...
    <script src="
	/PHP/boutique/inc/js/bootstrap.min.js"></script>
  </head>
  <body>
	...
	<nav class="navbar navbar-inverse ma-nav">
      <div class="container ma-nav">
        <div class="navbar-header">
		  ...
		  <a href="#"><img src="/PHP/boutique2/inc/img/logo2.png" width="60" height="53" style="padding: 5px;"></a>
