...
$content .='<div class="row row-offcanvas row-offcanvas-right">
        ...
        <div class="col-xs-12 col-sm-9">
          ...
          <div class="jumbotron">
            <h1>Bienvenue dans ma boutique PHP</h1>
            <p>CHOISISSEZ VOS ARTICLES ET PASSEZ COMMANDE !!!</p>
          </div>';
		...
		while($produit = $donnees->fetch(PDO::FETCH_ASSOC))
		{
		   ...
		   // <div class="row">
			...
			<div class="panel-default border">
              ...
              $content .='<a href="fiche_produit.php?id_produit=' . $produit['id_produit'] . '"><img class="img-responsive" src="photo/' . $produit['photo'] . '"></a><hr>';
