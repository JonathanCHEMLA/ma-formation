...
/*
Réaliser une fiche produit avec les informations : titre, catégorie, couleur, taille, photo, description, public, prix
...
if(isset($_GET['id_produit'])):
	...
	if($resultat->rowCount() <= 0) // si l'internaute tape dans l'URL un id_produit inconnu, on le redirige vers la page boutique pour ne pas avoir d'erreur 'unedifined' sur la page profil
	{
...
<div class="col-md-6 col-md-offset-3">
	<div class="panel-default border">
		...
		<div class="panel-body">
			<img src="<?= URL . 'photo/' . $produit['photo'] ?>" alt="" class="img-responsive"><hr>
			...
			<p class="text-center">Prix : <?= $produit['prix'] ?> €</p><hr>
			
		<?php if($produit['stock'] > 0): ?>
		
		<em>Nombre de produit(s) disponible : <?= $produit['stock'] ?></em><hr>
