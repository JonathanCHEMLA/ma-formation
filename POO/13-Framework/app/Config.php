...
class Config
{
	...
	public function __construct(){	
		require __DIR__ . '/Config/parameters.php';	// constante magique qui nous retourne le chemin du dossier en cours. C'est un require.
		$this->parameters = $parameters;	//je mets dans ma propriete, le contenu de $paraters de la page parameters.php.
...
//vu que $parameters est en protected, on aurait du avoir un getteer et un setter mais à la place on a:
